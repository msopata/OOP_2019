...
QT_MOC_LITERAL(3, 11, 12), // "valueChanged"
QT_MOC_LITERAL(4, 24, 11), // "doSomething"
QT_MOC_LITERAL(5, 36, 5) // "value"

    },
    "Demo\0test\0\0valueChanged\0doSomething\0"
    "value"
};
...
void Demo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Demo::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Demo::test)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Demo::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Demo::valueChanged)) {
                *result = 1;
                return;
            }
        }
